...
<ImagePair 
  images={[
    { src: "/static/img/trish/Alberto.JPG", alt: "Trish and Alberto before her stroke", caption: "Me and Alberto before my stroke" },
    { src: "/static/img/trish/Delia.jpg", alt: "Trish and Delia after her stroke", caption: "Me and Delia after my stroke" }
  ]} 
/>

<StoryImage src="/static/img/trish/Gang.jpg" alt="Trish and the gang" caption="Me and the 'gang'" />
...
<StoryImage src="/static/img/trish/Brain.jpg" alt="Trish's brain scan" caption="My brain scan" />
...
<StoryImage src="/static/img/trish/Karen.jpg" alt="Trish and Karen on a cruise" caption="Me and Karen on a cruise after my stroke" />
...
<ImagePair 
  images={[
    { src: "/static/img/trish/Rehabstory.jpg", alt: "All About Trish Hambridge story", caption: "All About Trish Hambridge (written by Karen)" },
    { src: "/static/img/trish/Rehabteam.jpg", alt: "Trish with her rehab team", caption: "Me with my team at Mission Oaks: Karen (my friend and a speech therapist), my occupational therapist, and my physical therapist" }
  ]} 
/>
...
<StoryImage src="/static/img/trish/Boat.JPG" alt="Trish driving a boat" caption="Me after my stroke, driving (a boat)!" />

<StoryImage src="/static/img/trish/Mom.JPG" alt="Trish's mom's 85th birthday" caption="My mom's 85th birthday" />
...
<StoryImage src="/static/img/trish/Burke.JPG" alt="Trish at Burke" caption="Me at Burke!" />
...
<ImagePair 
  images={[
    { src: "/static/img/trish/cruise.JPG", alt: "Voices of Hope cruise", caption: "Voices of Hope cruise" },
    { src: "/static/img/trish/VOC.jpg", alt: "More Voices of Hope", caption: "More Voices of Hope" }
  ]} 
/>

<StoryImage src="/static/img/trish/Halloween.JPG" alt="Halloween at Voices of Hope" caption="Halloween at Voices of Hope" />

<StoryImage src="/static/img/trish/Art.jpg" alt="Art made with Voices of Hope" caption="Art I made with Voices of Hope" />
...
<ImagePair 
  images={[
    { src: "/static/img/trish/Camera.JPG", alt: "Employee training at St. Petersburg", caption: "Employee training at St. Petersburg" },
    { src: "/static/img/trish/Celebrity.jpg", alt: "Trish in the news with Punk", caption: "Me in the news with Punk!" }
  ]} 
/>
...
<StoryImage src="/static/img/trish/ASHA.JPG" alt="ASHA conference in New Orleans" caption="An ASHA conference in New Orleans" />

<ImagePair 
  images={[
    { src: "/static/img/trish/AA.JPG", alt: "Aphasia Access conference", caption: "An Aphasia Access conference" },
    { src: "/static/img/trish/OrlandoConference.JPG", alt: "Conference in Orlando", caption: "Another conference in Orlando" }
  ]} 
/>
...
<StoryImage src="/static/img/trish/studycircles.JPG" alt="Study with three participants" caption="A study where I was one of three participants" />
...
<StoryImage src="/static/img/trish/NAS.JPG" alt="National Aphasia Synergy team" caption="Me with my National Aphasia Synergy team!" />
