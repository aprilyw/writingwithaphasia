...
hero: "/stories/ayse/Now.jpg"
heroAlt: "Ayse's aphasia communication card titled Card1 with supportive phrases"
excerpt: "If you are meeting me for the first time, you might be greeted with these aphasia cards… but there is a lot more to my life. I have a story to share!"
---
...
<ImageGrid columns={2} natural={false} aspect="aspect-[3/4]" alignY="bottom" gap="gap-6" imageFit="contain">
	<Figure src="/stories/ayse/Card1.png" caption="" size="sm" fit="contain" />
	<Figure src="/stories/ayse/Card2.png" caption="" size="sm" fit="contain" />
</ImageGrid>
<ImageGrid columns={2} natural={false} aspect="aspect-[4/5]" alignY="bottom" gap="gap-6" imageFit="cover">
	<Figure src="/stories/ayse/AyseAsKid.JPEG" caption="Me as a child." fit="cover" />
	<Figure src="/stories/ayse/Now.jpg" caption="Me now!" fit="cover" />
</ImageGrid>
...
<Figure src="/stories/ayse/Don.jpg" caption="My husband Don." fit="contain" />

<Figure src="/stories/ayse/IMG_3300.jpg" caption="Me and Don." fit="contain" />
...
<Figure src="/stories/ayse/Wedding.JPEG" caption="A family photo from Michael and Ashley's wedding. My mother, stepfather, cousin, and his son all came from Turkey to attend." size="lg" fit="contain" />
...
<Figure src="/stories/ayse/HeinekenPrez.JPEG" caption="Me with the President of Heineken." fit="contain" />
<Figure src="/stories/ayse/Heineken.JPEG" caption="The Heineken Sales Campus." fit="contain" />
...
<Figure src="/stories/ayse/BellyDancing.JPEG" caption="Me bellydancing when I was younger." fit="contain" />
<Figure src="/stories/ayse/Newspaper.jpg" caption="A newspaper feature on my belly dancing classes." fit="contain" />
...
<Figure src="/stories/ayse/Therapy3.JPG" caption="Photos from earlier therapy in 2010." />
...
<Figure src="/stories/ayse/Friend.JPEG" caption="Me with a friend who also lives with aphasia." fit="cover" position="center" />
...
<ImageGrid columns={2} natural={false} aspect="aspect-[4/5]" alignY="bottom" imageFit="cover">
	<Figure src="/stories/ayse/GM.JPG" caption="" fit="cover" />
	<Figure src="/stories/ayse/GM3.JPG" caption="" fit="cover" />
</ImageGrid>
...
<ImageGrid columns={2} natural={false} aspect="aspect-[4/5]" alignY="bottom" imageFit="cover">
	<Figure src="/stories/ayse/NAAAmbassador.JPEG" caption="Also at Georgia State University!" fit="cover" />
	<Figure src="/stories/ayse/NAA.jpg" caption="My NAA certificate." fit="cover" />
</ImageGrid>
