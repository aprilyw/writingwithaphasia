...
date: "2025-09-14"
hero: "/static/img/ayse/AyseInfo.JPEG"
...
<ImageGrid columns={2}>
  <Figure src="/static/img/ayse/Flowers.jpg" alt="Flowers" caption="Flowers" />
  <Figure src="/static/img/ayse/Dog.JPEG" alt="Dog" caption="Dog" />
  <Figure src="/static/img/ayse/Now.jpg" alt="Now" caption="Now" />
  <Figure src="/static/img/ayse/NeverGiveUp.JPEG" alt="Never Give Up" caption="Never Give Up" />
</ImageGrid>
