// pages/_app.js
import '../styles/palette.generated.css';
...
export default function App({ Component, pageProps }) {
  ...
  <nav aria-label="Main" className="w-full border-b border-neutral-300 bg-[var(--color-surface-mist)]/80 backdrop-blur supports-[backdrop-filter]:bg-[var(--color-surface-mist)]/60">
